...
class _Viglink
{
	...
	public function edit()
	{
		...
		if ( \IPS\Settings::i()->viglink_api_key )
		{
			...
			$form->add( new \IPS\Helpers\Form\Select( 'viglink_groups', \IPS\Settings::i()->viglink_groups , FALSE, array( 'options' => \IPS\Member\Group::groups(), 'parse' => 'normal', 'multiple' => true, 'unlimited' => 'all', 'unlimitedLang' => 'all_groups' ), NULL, NULL, NULL, 'viglink_groups' ) );
			$form->add( new \IPS\Helpers\Form\Select( 'viglink_norewrite', \IPS\Settings::i()->viglink_norewrite , FALSE, array( 'options' => \IPS\Member\Group::groups(), 'parse' => 'normal', 'multiple' => true ), NULL, NULL, NULL, 'viglink_norewrite' ) );
