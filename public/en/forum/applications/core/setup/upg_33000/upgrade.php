...
class _Upgrade
{
	...
	public function step7()
	{
		...
		if( \IPS\Db::i()->select( 'count(*)', 'posts' )->first() > 100000 )
		{
			...
			return array( 'html' => \IPS\Theme::i()->getTemplate( 'forms' )->queries( $queries, \IPS\Http\Url::internal( 'controller=upgrade' )->setQueryString( array( 'key' => $_SESSION['uniqueKey'], 'mr_continue' => 1, 'mr' => \IPS\Request::i()->mr ) ) ) );
		}
