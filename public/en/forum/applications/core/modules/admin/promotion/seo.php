...
class _seo extends \IPS\Dispatcher\Controller
{
	...
	protected function _manageUrls()
	{
		...
		{
			$form->add( new \IPS\Helpers\Form\YesNo( 'htaccess_mod_rewrite', \IPS\Settings::i()->htaccess_mod_rewrite, TRUE, array('togglesOff' => array( 'htaccess_mod_rewrite_warning' ) ), function( $val )
			{
				if ( $val )
				{
					...
					{
						throw new \LogicException( 'htaccess_mod_rewrite_err' );
					}
				}
			}, NULL, NULL, 'htaccess_mod_rewrite' ) );
		}
		else
		{
			$form->add( new \IPS\Helpers\Form\YesNo( 'htaccess_mod_rewrite', \IPS\Settings::i()->htaccess_mod_rewrite, TRUE ) );
			\IPS\Member::loggedIn()->language()->words['htaccess_mod_rewrite_warning']	= \IPS\Member::loggedIn()->language()->get('htaccess_mod_rewrite_warning_na');
	...
	protected function _manageSitemap()
	{
		/* Init */
		$form = new \IPS\Helpers\Form;
		$form->add( new \IPS\Helpers\Form\Text( 'sitemap_url', \IPS\Settings::i()->sitemap_url ?: \IPS\Settings::i()->base_url . 'sitemap.php', FALSE ) );
	...
	public function addMeta()
	{
		...
		$form->add( new \IPS\Helpers\Form\Text( 'metatag_url', $url, TRUE, array( 'placeholder' => 'profile/*' ), NULL, \IPS\Settings::i()->base_url ) );
