...
class _settings extends \IPS\Dispatcher\Controller
{
	...
	protected function manageArchiving()
	{
		...
		$form->add( new \IPS\Helpers\Form\Custom( 'archive_last_post', isset( $existingValues['archive_last_post'] ) ? $existingValues['archive_last_post'] : array( '>', 0, 'm', TRUE ), FALSE, array( 'getHtml' => array( $this, '_beforeAfterTimeAgo' ) ), NULL, NULL, NULL, 'archive_last_post' ) );
		...
		$form->add( new \IPS\Helpers\Form\Custom( 'archive_not_last_post', isset( $existingValues['archive_not_last_post'] ) ? $existingValues['archive_not_last_post'] : array( '>', 0, 'm', TRUE ), FALSE, array( 'getHtml' => array( $this, '_beforeAfterTimeAgo' ) ), NULL, NULL, NULL, 'archive_not_last_post' ) );
