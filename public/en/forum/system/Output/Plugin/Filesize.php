...
class _Filesize
{
	 ...
	 * @return	string
	 */
	public static function humanReadableFilesize( $sizeInBytes, $decimal=FALSE )
	{
		...
		foreach ( array( 'Y' => 80, 'Z' => 70, 'E' => 60, 'P' => 50, 'T' => 40, 'G' => 30, 'M' => 20, 'k' => 10 ) as $sig => $pow )
		{
			...
			{
				return \IPS\Member::loggedIn()->language()->addToStack( 'filesize_' . $sig, FALSE, array( 'sprintf' => round( ( $sizeInBytes / $raised ), 1 ) ) );
			}
		}

		return \IPS\Member::loggedIn()->language()->addToStack( 'filesize_b', FALSE, array( 'sprintf' => $sizeInBytes ) );
	}
}