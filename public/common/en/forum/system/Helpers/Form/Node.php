...
class _Node extends FormAbstract
{
	 ...
	 * @code
	 	$defaultOptions = array(
	 		...
	 		'disabled'			=> array(),						// Array of disabled IDs
	...
	public function html()
	{
		...
		else
		{
			...
			foreach( $nodeClass::roots( 'view', NULL, $this->options['where'] ) AS $node )
			{
		...
		/* Display */
		return \IPS\Theme::i()->getTemplate( 'forms', 'core', 'global' )->node( $this->name, $selected, $this->options['multiple'], $this->options['url'], $nodeClass::$nodeTitle, $nodes, $this->options['zeroVal'], $noJS, $permCheck, $this->options['subnodes'], $this->options['togglePerm'], $this->options['toggleIds'], $disabledCallback, $this->options['zeroValTogglesOn'], $this->options['zeroValTogglesOff'], TRUE, $children, $this->options['class'], $this->options['where'], is_array( $this->options['disabled'] ) ? $this->options['disabled'] : array(), $this->options['noParentNodes'], $noParentNodes );
	}
