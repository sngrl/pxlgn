...
class _Plugin extends \IPS\Node\Model
{
	...
	public function form( &$form )
	{
		...
		$form->add( new \IPS\Helpers\Form\Text( 'plugin_location', $this->location, FALSE, array( 'disabled' => $this->_id, 'maxlength' => 32, 'regex' => '/^[a-z0-9]*$/i' ) ) );
...
CODE;
	...
	public function delete()
	{
		...
		if ( file_exists( \IPS\ROOT_PATH . '/plugins/' . $this->location ) )
		{
			...
			@rmdir( \IPS\ROOT_PATH . '/plugins/' . $this->location );
		}
