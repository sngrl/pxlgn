	...
	*/
	...
	public static function modules()
	{
		if( static::$modules === NULL )
		{
			...
			{
				$rows = iterator_to_array( \IPS\Db::i()->select( '*', 'core_modules' )->join( 'core_permission_index', array( "core_permission_index.app=? AND core_permission_index.perm_type=? AND core_permission_index.perm_type_id=core_modules.sys_module_id", 'core', 'module' ) ) );
