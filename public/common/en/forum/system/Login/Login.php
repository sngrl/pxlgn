...
class _Login
{
	...
	public static function getDestination()
	{
		...
		{
			return new \IPS\Http\Url( @base64_decode( \IPS\Request::i()->ref ) ?: \IPS\Request::i()->ref );
		}
		...
		return isset( $_SERVER['HTTP_REFERER'] ) ? \IPS\Http\Url::external( $_SERVER['HTTP_REFERER'] ) : \IPS\Http\Url::internal( '' );
	}
	...
	public static function getRegistrationDestination( $member )
	{
		...
		{
			return \IPS\Http\Url::internal( 'app=core&module=system&controller=register&do=validating' );
		}
