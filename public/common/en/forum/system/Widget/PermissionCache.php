...
class _PermissionCache extends \IPS\Widget
{
	...
	public function __construct( $uniqueKey, array $configuration, $access=null, $orientation=null )
	{
		...
		$this->cacheKey = "widget_{$this->key}_" . $this->uniqueKey . '_' . md5( json_encode( $configuration ) . "_" . \IPS\Member::loggedIn()->language()->id . "_" . json_encode( \IPS\Member::loggedIn()->groups ) . "_" . $orientation );
	}
}