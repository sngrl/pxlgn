...
class _Calendars
{
	...
	{
		return new \IPS\Helpers\Form\Node( 'announce_calendars', ( $announcement ) ? explode( ",", $announcement->ids ) : NULL, FALSE, array( 'class' => 'IPS\calendar\Calendar', 'zeroVal' => 'any', 'multiple' => TRUE ), NULL, NULL, NULL, 'announce_calendars' );
	}
}