...
$lang = array(
	...
	'upgrade_step_2'		=> "Upgrading applications...",
	'upgrade_step_3'		=> "Upgrading settings, tasks, widgets and search keywords...",
	'upgrade_step_4'		=> "Upgrading languages...",
	'upgrade_step_5'		=> "Upgrading email templates...",
	'upgrade_step_6'		=> "Upgrading theme settings...",
	'upgrade_step_7'		=> "Removing old theme templates, css and images...",
	'upgrade_step_8'		=> "Upgrading theme templates, css and images...",
	'upgrade_step_9'		=> "Upgrading javascript...",
	...
	'requirements_mysql_version_fail'	=> "You are running MySQL version %s. You need MySQL 5.0.3 or above (5.6.0 or above recommended). You should contact your hosting provider or system administrator to ask for an upgrade.",
	'requirements_mysql_version_advice'	=> "You are running MySQL version %s. While this version is compatible, we recommend version 5.6.0 or above.",
