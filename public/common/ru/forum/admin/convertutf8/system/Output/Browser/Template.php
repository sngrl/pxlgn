...
EOFHTML;
      ...
      {$content}
      <div class="footer">
        <p>UTF8 Converter v{$version} &copy; 2014 Invision Power Services, Inc.</p>
      </div>
    </div>
...
EOFHTML;
	...
	public static function welcome( $isUtf8=false, $status, $percent=false, $controller='browser' )
	{
		...
		$canUseMb4			= ( version_compare( \IPSUtf8\Db::i()->server_info, '5.5.3', '>=' ) );
...
EOFHTML;
		...
		if ( \IPSUtf8\Request::i()->controller === 'browser' )
		{
			if( !$updated )
			{
				$utf8mb4 = ( $sql_charset == 'utf8mb4' ) ? "\n\$INFO['sql_utf8mb4'] = true;" : '';
$html .= <<<EOFHTML
        <p>You can now <strong>complete the conversion</strong> by editing conf_global.php to add <code>\$INFO['sql_charset'] = '{$sql_charset}';{$utf8mb4}</code>. Afterwards, you can <strong><a href="../upgrade">proceed with the upgrade</strong>.</p>
      </div>
EOFHTML;
			}
			else
