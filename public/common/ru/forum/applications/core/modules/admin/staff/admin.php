...
class _admin extends \IPS\Dispatcher\Controller
{
	...
	protected function save()
	{
		...
		/* Save */
		\IPS\Db::i()->update( 'core_admin_permission_rows', array( 'row_perm_cache' => json_encode( \IPS\Request::i()->r ), 'row_updated' => time() ), array( "row_id=? AND row_id_type=?", intval( \IPS\Request::i()->id ), \IPS\Request::i()->type ) );
