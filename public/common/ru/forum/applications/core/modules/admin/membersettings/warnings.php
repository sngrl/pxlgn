...
class _warnings extends \IPS\Node\Controller
{
	...
	{		
		...
		if ( $activeTab == 'settings' )
		{
			...
			$form->add( new \IPS\Helpers\Form\Select( 'warn_protected', \IPS\Settings::i()->warn_protected, FALSE, array( 'options' => \IPS\Member\Group::groups( TRUE, FALSE ), 'parse' => 'normal', 'multiple' => TRUE ), NULL, NULL, NULL, 'warn_protected' ) );
