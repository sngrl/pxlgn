...
class _GroupLimits
{
	...
	public function getLimits()
	{
		return array (
						...
						'neg1IsBest'	=> array( 'g_attach_max', 'g_attach_per_post', 'g_max_bgimg_upload' ),
						'zeroIsBest'	=> array( 'g_edit_cutoff', 'g_max_messages', 'g_pm_perday', 'g_pm_flood_mins', 'g_displayname_unit', 'g_sig_unit', 'g_mod_preview', 'g_ppd_limit', 'g_ppd_unit', 'gbw_no_status_update', 'g_max_bgimg_upload', 'gbw_disable_prefixes', 'gbw_disable_tagging' ),
						'callback'		=> array(
