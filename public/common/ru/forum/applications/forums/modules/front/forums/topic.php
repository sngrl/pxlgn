...
class _topic extends \IPS\Content\Controller
{
	...
	protected function manage()
	{
		...
		\IPS\Output::i()->metaTags['description'] = \IPS\Output::i()->metaTags['og:description'] = strip_tags( $topic->isQuestion() ? $question->post : $current->post );
	...
	public function savedAction()
	{
		try
		{
			...
			/* Log */
			\IPS\Session::i()->modLog( 'modlog__saved_action', array( $action->mm_title => FALSE, $topic->url()->__toString() => FALSE, $topic->mapped( 'title' ) => FALSE ), $topic );
