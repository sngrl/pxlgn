...
class _hotTopics extends \IPS\Widget\PermissionCache
{
	...
	{
		$topics = \IPS\forums\Topic::getItemsWithPermission( array( array( 'popular_time > ?', time() ) ), NULL, isset( $this->configuration['number_to_show'] ) ? $this->configuration['number_to_show'] : 5 );
		if ( count( $topics ) )
		{
