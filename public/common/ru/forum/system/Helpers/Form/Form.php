...
class _Form
{
	...
	public function __construct( $id='form', $submitLang='save', $action=NULL, $attributes=array() )
	{
		...
		$this->uploadField = min( (float) ini_get('upload_max_filesize'), (float) ini_get('post_max_size'), (float) ini_get('memory_limit') ) * 1048576;
	}
	...
	public function addMessage( $lang, $css='', $parse=TRUE, $_id=NULL )
	{
		...
		$this->elements[ $this->currentTab ][] = \IPS\Theme::i()->getTemplate( 'forms', 'core' )->message( $lang, $_id, $css, $parse );
	}
