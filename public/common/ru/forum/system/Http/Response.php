...
class _Response
{
	...
	public function __construct( $content )
	{
		...
		if( isset( $this->httpHeaders['Transfer-Encoding'] ) and mb_strtolower( $this->httpHeaders['Transfer-Encoding'] ) == 'chunked' )
		{
	...
	public function decodeChunked( $body )
	{
		...
		{			
			...
			if( $_pos === FALSE OR !preg_match( "/^([a-f0-9]+)$/", \substr( $body, 0, $_pos ) ) )
			{
				return $initial;
			}
