...
/**
 * @brief	Database Class
 * @note	All functionality MUST be supported by MySQL 5.0.3 and higher. All references to the MySQL manual are therefore the 5.0 version.
 */
class _Db extends \mysqli
{
	 ...
	 *
	 * @see		<a href='http://dev.mysql.com/doc/refman/5.0/en/insert.html'>INSERT Syntax</a>
	 ...
	 *
	 * @see		<a href='http://dev.mysql.com/doc/refman/5.0/en/replace.html'>REPLACE Syntax</a>
	 * @param	string	$table	Table name
	 ...
	 *
	 * @see		\IPS\Db::build
	 * @see		<a href='http://dev.mysql.com/doc/refman/5.0/en/update.html'>UPDATE Syntax</a>
	 ...
	 *
	 * @see		\IPS\Db::build
	 * @see		<a href='http://dev.mysql.com/doc/refman/5.0/en/delete.html'>DELETE Syntax</a>
	 * @param	string				$table		Table Name
	 ...
	 * @encode
	 * @see		<a href='http://dev.mysql.com/doc/refman/5.0/en/create-table.html'>MySQL CREATE TABLE syntax</a>
	 ...
	 * @encode
	 * @see		<a href='http://dev.mysql.com/doc/refman/5.0/en/create-index.html'>MySQL CREATE INDEX syntax</a>
	 ...
	 * Rename table
	 *
	 * @see		<a href='http://dev.mysql.com/doc/refman/5.0/en/rename-table.html'>Rename Table</a>
	 ...
	 * Drop table
	 *
	 * @see		<a href='http://dev.mysql.com/doc/refman/5.0/en/drop-table.html'>DROP TABLE Syntax</a>
	...
	public function changeIndex( $table, $index, $definition )
	{
		...
		return $this->addIndex( $table, $definition );
	}
	...
	public function buildIndex( $table, $definition )
	{
		...
		{
			$this->query( "ALTER TABLE `{$this->prefix}{$this->escape_string( $table )}` ENGINE={$data['engine']}" );
		}

		/* Extract the key we want to add */
		$definition = $data['indexes'][ $indexName ];

		return "ADD {$this->compileIndexDefinition( $definition )}";
	}
